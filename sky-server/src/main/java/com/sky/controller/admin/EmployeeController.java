...
@Slf4j
@Api(tags = "Employee API") // tag for Swagger
public class EmployeeController {
     ...
     */
    @GetMapping("/page")
    @ApiOperation("Employee List Pagination")
    public Result<PageResult> page(EmployeePageQueryDTO employeePageQueryDTO) {
        log.info("Employee List Pagination:{}", employeePageQueryDTO);
     ...
     */
    @PutMapping
    @ApiOperation("Edit employee details")
    public Result upadateEmployee(@RequestBody EmployeeDTO employeeDTO) {
        log.info("Update employee details: {}", employeeDTO);
