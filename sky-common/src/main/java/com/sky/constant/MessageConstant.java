...
public class MessageConstant {
    ...
    public static final String ALREADY_EXISTS = "exist";
    public static final String UNKNOWN_ERROR = "Unknown error";
    public static final String USER_NOT_LOGIN = "User does not logged in";
    public static final String CATEGORY_BE_RELATED_BY_SETMEAL = "The current category is associated with set meals, cannot delete";
    public static final String CATEGORY_BE_RELATED_BY_DISH = "The current category is associated with dishes, cannot delete";
    ...
    public static final String SETMEAL_ENABLE_FAILED = "The set meal contains unsold dishes, cannot launch";
    ...
    public static final String DISH_BE_RELATED_BY_SETMEAL = "The current dish is associated with set meals, cannot delete";
